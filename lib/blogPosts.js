export const blogPosts = [
  {
    ...
    metaTitle: 'VAPT Testing Guide India 2025 | BugZero Cyber Blog',
    metaDescription: 'Complete guide to VAPT for Indian businesses in 2025. Covers methodology, pricing, CERT-In compliance, RBI requirements & how to choose the right VAPT provider.',
...
5. Re-testing included in the engagement`,
  ...
  },
  {
    ...
    metaTitle: 'Top Cybersecurity Threats India 2025 | BugZero Blog',
    metaDescription: 'Comprehensive analysis of top cybersecurity threats for Indian organizations in 2025 — ransomware, APT groups, state-sponsored attacks, UPI fraud & cloud breaches.',
...
- Maintain an incident response plan`,
  ...
  },
  {
    ...
    metaTitle: 'Bug Bounty Program Guide India | VDP Setup | BugZero Blog',
    metaDescription: 'Step-by-step guide for Indian companies to design, launch & manage effective bug bounty programs. Includes policy templates, reward structures & vendor selection criteria.',
...
- Low severity: ₹1,000 – ₹5,000`,
  ...
  },
  {
    ...
    metaTitle: 'Pen Testing vs Vulnerability Assessment | BugZero Blog',
    metaDescription: 'Key differences between penetration testing and vulnerability assessment. Learn when to use each, how they complement each other & choose the right approach for India.',
...
- **After major changes:** Targeted testing for modified components`,
  ...
  },
  {
    ...
    metaTitle: 'Cloud Security Best Practices India | AWS Azure GCP Guide',
    metaDescription: 'Practical cloud security guide for Indian enterprises. AWS, Azure & GCP configurations, IAM best practices, CERT-In compliance & common misconfigurations to avoid.',
