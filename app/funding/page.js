...
const problemStats = [
  ...
  { value: '74%', label: 'Indian companies face cyber attacks yearly', icon: Shield, color: 'text-cyber-saffron' },
...
const marketData = {
  tam: { value: '₹35,000 Cr', label: 'Total Addressable Market', desc: 'India cybersecurity market by 2027', color: 'bg-cyber-blue' },
  sam: { value: '₹8,000 Cr', label: 'Serviceable Addressable Market', desc: 'SME + Government segment', color: 'bg-cyber-purple' },
  som: { value: '₹500 Cr', label: 'Serviceable Obtainable Market', desc: 'Realistic 5-year target', color: 'bg-cyber-green' },
};
...
const fundUtilization = [
  { label: 'Product Development', pct: 40, desc: 'AI security platform & automation tools', color: 'bg-cyber-blue', textColor: 'text-cyber-blue' },
  { label: 'Team Expansion', pct: 25, desc: '10 new security engineers & researchers', color: 'bg-cyber-purple', textColor: 'text-cyber-purple' },
  { label: 'Marketing & BD', pct: 20, desc: 'Government contracts & enterprise sales', color: 'bg-cyber-green', textColor: 'text-cyber-green' },
  { label: 'Infrastructure', pct: 15, desc: 'Certifications, labs & cloud infrastructure', color: 'bg-cyber-saffron', textColor: 'text-cyber-saffron' },
];
  ...
  return (
    <div className="relative">
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyber-saffron/10 border border-cyber-saffron/20 text-cyber-saffron text-sm font-medium mb-6">
          ...
          >
            Invest in India&apos;s <span className="gradient-text">Cybersecurity Future</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            The Indian cybersecurity market is projected to reach <span className="text-white font-semibold">₹35,000 Crore by 2027</span>.
            BugZero is positioned to capture this explosive growth with a seed funding ask of <span className="text-cyber-blue font-semibold">₹1 Crore</span>.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <SectionWrapper>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-blue text-sm font-semibold tracking-wider uppercase">Executive Summary</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">The Opportunity</h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <motion.div {...fadeUp} className="cyber-card rounded-xl p-8">
              <h3 className="text-xl font-bold text-white font-heading mb-4 flex items-center gap-2">
                <Target className="w-5 h-5 text-cyber-blue" /> Market Context
              </h3>
              <ul className="space-y-3 text-gray-300 text-sm leading-relaxed">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />India&apos;s cybersecurity market projected to reach ₹35,000 Crore by 2027</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />74% of Indian companies face cyber attacks annually</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />Critical shortage of 1 million+ cybersecurity professionals in India</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />Government actively promoting cybersecurity through Digital India</li>
              </ul>
            </motion.div>
            <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="cyber-card rounded-xl p-8">
              <h3 className="text-xl font-bold text-white font-heading mb-4 flex items-center gap-2">
                <Lightbulb className="w-5 h-5 text-cyber-saffron" /> Our Proposition
              </h3>
              <ul className="space-y-3 text-gray-300 text-sm leading-relaxed">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />Comprehensive cybersecurity services for SMEs and enterprises</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />AI-powered security scanning platform (SaaS model)</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />Team of CEH, OSCP, CISSP certified professionals</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-cyber-green mt-0.5 shrink-0" />Seed funding ask: ₹1 Crore for platform development & expansion</li>
              </ul>
            </motion.div>
          </div>
        </div>
      ...
      <SectionWrapper className="bg-gradient-to-b from-transparent via-red-950/10 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">India&apos;s Cybersecurity Crisis</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {problemStats.map((s, i) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-white font-heading mb-1">{s.value}</div>
      ...
      <SectionWrapper>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-green text-sm font-semibold tracking-wider uppercase">Our Solution</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">How BugZero Solves This</h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {solutionItems.map((item, i) => (
              ...
              >
                <div className="w-12 h-12 shrink-0 rounded-xl bg-cyber-green/10 border border-cyber-green/20 flex items-center justify-center">
      ...
      <SectionWrapper className="bg-gradient-to-b from-transparent via-cyber-purple/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-purple text-sm font-semibold tracking-wider uppercase">Market Opportunity</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">Massive Addressable Market</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {Object.entries(marketData).map(([key, data], i) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-white font-heading mb-1">{data.value}</div>
                <div className="text-sm font-semibold text-gray-300 mb-1">{data.label}</div>
      ...
      <SectionWrapper>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-blue text-sm font-semibold tracking-wider uppercase">Business Model</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">Diversified Revenue Streams</h2>
          </motion.div>
            ...
            {businessModel.map((bm, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-cyber-blue/10 border border-cyber-blue/20 flex items-center justify-center mx-auto mb-3">
                  <bm.icon className="w-6 h-6 text-cyber-blue" />
                </div>
                <div className="text-2xl font-bold text-cyber-blue font-heading mb-1">{bm.pct}</div>
                <h3 className="text-sm font-semibold text-white mb-1">{bm.title}</h3>
                <p className="text-xs text-gray-400">{bm.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <SectionWrapper className="bg-gradient-to-b from-transparent via-cyber-blue/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-green text-sm font-semibold tracking-wider uppercase">Traction & Milestones</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">Proven Track Record</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {traction.map((t, i) => (
              ...
              >
                <t.icon className="w-5 h-5 text-cyber-green mx-auto mb-2" />
                <div className="text-xl font-bold text-white font-heading">{t.value}</div>
      ...
      <SectionWrapper>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-saffron text-sm font-semibold tracking-wider uppercase">Fund Utilization</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">
              How We&apos;ll Use <span className="text-cyber-blue">₹1 Crore</span>
            </h2>
          </motion.div>
              ...
              {fundUtilization.map((fu, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-semibold text-white">{fu.label}</span>
                    <span className={`text-sm font-bold ${fu.textColor}`}>{fu.pct}% (₹{(fu.pct * 1).toFixed(0)} Lakhs)</span>
                  </div>
                  <div className="w-full h-3 rounded-full bg-cyber-card border border-cyber-border overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                  ...
                  <p className="text-xs text-gray-500 mt-1">{fu.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <SectionWrapper className="bg-gradient-to-b from-transparent via-cyber-saffron/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            <span className="text-cyber-saffron text-sm font-semibold tracking-wider uppercase">Government Schemes</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-white mt-2">Eligible Government Programs</h2>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            ...
            {govSchemes.map((gs, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <h3 className="text-sm font-semibold text-white font-heading pr-2">{gs.name}</h3>
                ...
                <p className="text-xs text-gray-400">{gs.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.2 }}>
              <div className="cyber-card rounded-xl p-6 sm:p-8">
                <h3 className="text-xl font-bold text-white font-heading mb-6">Contact for Investment</h3>
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-cyber-bg border border-cyber-border text-white placeholder-gray-500 focus:border-cyber-blue focus:ring-1 focus:ring-cyber-blue outline-none transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-cyber-bg border border-cyber-border text-white placeholder-gray-500 focus:border-cyber-blue focus:ring-1 focus:ring-cyber-blue outline-none transition-colors resize-none"
