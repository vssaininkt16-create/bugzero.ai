...
const teamMembers = [
  {
    ...
    bio: 'Visionary cybersecurity leader with extensive experience in offensive security, building India\'s next-gen cybersecurity company.',
    certs: ['CEH', 'OSCP'],
  ...
  },
  {
    ...
    bio: 'Expert in building scalable security platforms. Leading the development of AI-powered threat detection systems.',
    certs: ['CISSP', 'AWS Security'],
    color: 'from-cyber-purple to-cyber-green',
  },
  {
    name: 'Head of Operations',
    role: 'VP Operations',
    bio: 'Streamlining security delivery processes to ensure world-class service quality for every client engagement.',
    certs: ['PMP', 'ISO 27001 LA'],
    color: 'from-cyber-green to-cyber-blue',
  },
  {
    name: 'Lead Security Researcher',
    role: 'Principal Researcher',
    bio: 'Discovered critical vulnerabilities in major platforms. Leading BugZero\'s advanced security research team.',
    certs: ['OSCP', 'CRTP'],
    color: 'from-cyber-saffron to-cyber-blue',
  },
];
...
const industries = ['Banking & BFSI', 'Healthcare', 'Government', 'Fintech'];
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div {...fadeUp} className="cyber-card rounded-xl p-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                To make India&apos;s cyberspace the safest in the world by empowering organizations
                with elite security expertise, cutting-edge technology, and unwavering commitment
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="cyber-card rounded-xl p-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Become India&apos;s #1 cybersecurity company by 2027, securing 1,000+ organizations
                and training 10,000 cybersecurity professionals to build a safer digital India
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              A team of certified security experts with decades of combined experience.
            </p>
          </motion.div>
      ...
      <SectionWrapper className="bg-gradient-to-b from-transparent via-cyber-blue/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div {...fadeUp} className="mt-12 text-center">
            <h3 className="text-lg font-semibold text-white font-heading mb-4">Industries Served</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {certifications.map((cert, i) => (
              <motion.div
                ...
                className="cyber-card rounded-xl p-5 flex gap-4"
              >
          ...
          >
            ...
            <div className="relative z-10 p-8 sm:p-12 text-center">
              ...
              <p className="text-gray-300 mb-8 max-w-xl mx-auto">
                Partner with us to build a safer digital India. Whether you&apos;re an enterprise,
                government body, or investor, we&apos;d love to connect.
              </p>
