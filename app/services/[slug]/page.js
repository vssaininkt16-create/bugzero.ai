      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-sm text-gray-400 mb-8">
            ...
            <Link href="/services" className="hover:text-cyber-blue transition-colors">Services</Link>
            <ChevronRight className="w-3.5 h-3.5" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              {service.badge && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyber-blue/10 border border-cyber-blue/20 text-cyber-blue text-sm font-medium mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">{service.summary}</p>
              <div className="flex items-center gap-4 mb-8">
                {service.price && (
                  <div>
                    <span className="text-2xl font-bold text-white font-heading">{service.priceDisplay}</span>
                    <span className="text-sm text-gray-500 ml-1">onwards</span>
                  </div>
                )}
                {!service.price && (
                  <span className="text-xl font-bold text-cyber-blue font-heading">Custom Pricing</span>
                )}
              </div>
            ...
            {/* Quick info card */}
            <div className="cyber-card rounded-xl p-6 lg:mt-0">
              <h2 className="text-lg font-bold text-white font-heading mb-4 flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-cyber-green" /> What&apos;s Included
              </h2>
              ...
              <div className="mt-6 pt-4 border-t border-cyber-border">
                <p className="text-xs text-gray-500 mb-3">Need a custom scope? Talk to our experts.</p>
                <a href="mailto:contact@bugzero.solutions" className="flex items-center gap-2 text-sm text-cyber-blue hover:underline">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <span className="text-cyber-blue text-sm font-semibold tracking-wider uppercase">Coverage</span>
              <h2 className="text-2xl sm:text-3xl font-bold font-heading text-white mt-2 mb-6">What We Test & Cover</h2>
            ...
            <div>
              <span className="text-cyber-purple text-sm font-semibold tracking-wider uppercase">About This Service</span>
              <h2 className="text-2xl sm:text-3xl font-bold font-heading text-white mt-2 mb-6">Service Overview</h2>
        ...
        <section className="py-16 sm:py-20 bg-gradient-to-b from-transparent via-cyber-blue/5 to-transparent">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold font-heading text-white mt-2">Frequently Asked Questions</h2>
            </div>
            <div className="space-y-4">
              {service.faq.map((item, i) => (
                <div key={i} className="cyber-card rounded-xl p-6">
                  <h3 className="text-base font-semibold text-white font-heading mb-2">{item.question}</h3>
