...
const govAlignment = [
  {
    title: 'National Cybersecurity Policy 2020',
    desc: 'Fully aligned with India\'s national cybersecurity framework and guidelines.',
    icon: Shield,
  },
  {
    title: "PM's Digital India Vision",
    desc: 'Supporting the vision of a digitally empowered and secure India.',
    icon: Globe,
  },
  {
    title: 'Cyber Surakshit Bharat Initiative',
    desc: 'Active partner in MeitY\'s initiative to build a robust cybersecurity ecosystem.',
    icon: ShieldCheck,
  },
  {
    title: 'DPIIT Recognized Startup',
    desc: 'Officially recognized under the Startup India initiative by the Government of India.',
    icon: Award,
  },
];
...
const testimonials = [
  {
    ...
    text: "BugZero's VAPT assessment uncovered critical vulnerabilities that our previous vendor completely missed. Their team's expertise in banking security is unmatched.",
    rating: 5,
  },
  {
    name: 'Dr. Priya Sharma',
    role: 'CISO, MedTech Healthcare',
    text: 'The thoroughness and professionalism of BugZero\'s security audit gave us complete confidence in our patient data protection. Truly government-grade security.',
    rating: 5,
  },
  {
    name: 'Amit Patel',
    role: 'CEO, CloudFirst Technologies',
    text: 'From cloud security assessment to ongoing SOC monitoring, BugZero has been our trusted security partner. Their 24/7 response team is exceptional.',
    rating: 5,
  },
  {
    name: 'Sneha Reddy',
    role: 'VP Engineering, PaySafe Fintech',
    text: 'BugZero helped us achieve PCI DSS compliance in record time. Their expertise in fintech security is exactly what the Indian startup ecosystem needs.',
    rating: 5,
  },
];
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {clientSectors.map((sector, i) => (
              <motion.div
                ...
                className="cyber-card rounded-xl p-5 text-center group"
              >
