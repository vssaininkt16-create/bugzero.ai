    ...
    <>
      ...
      <section className="relative py-20 sm:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-sm text-gray-600 mb-8">
            ...
            <span className="text-gray-900">Responsible Disclosure</span>
          </nav>
          <div className="flex items-center gap-3 mb-4">
            <Bug className="w-8 h-8 text-green-600" />
            <h1 className="text-3xl sm:text-4xl font-bold font-heading text-gray-900">Responsible Disclosure Policy</h1>
          </div>
          <p className="text-gray-700 text-sm mb-4">Last Updated: March 2025</p>
      ...
      <section className="pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          {/* Safe Harbor */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 border-green-200 bg-green-50">
            <div className="flex items-start gap-3">
              <Shield className="w-6 h-6 text-green-600 shrink-0 mt-0.5" />
              <div>
                <h2 className="text-lg font-bold text-gray-900 font-heading mb-2">Safe Harbor</h2>
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-bold text-gray-900 font-heading mb-6">Disclosure Process</h2>
            <div className="space-y-4">
              {process.map((item) => (
                <div key={item.step} className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-red-50 border border-red-200 flex items-center justify-center shrink-0 text-red-600 text-sm font-bold">{item.step}</div>
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 font-heading">{item.title}</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
              <h2 className="text-base font-bold text-gray-900 font-heading mb-4 flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-600" /> In Scope
              </h2>
          ...
          {/* Guidelines */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-bold text-gray-900 font-heading mb-4">Researcher Guidelines</h2>
            <div className="text-gray-700 text-sm leading-relaxed space-y-3">
              <p className="text-gray-700">To qualify for safe harbor protection and potential recognition, please follow these guidelines:</p>
          ...
          {/* Recognition */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
            <h2 className="text-lg font-bold text-gray-900 font-heading mb-3">Recognition & Rewards</h2>
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 font-heading mb-2">Found a Vulnerability?</h2>
            <p className="text-gray-700 text-sm mb-6">Report it responsibly and help us make BugZero and the internet safer.</p>
            ...
            <p className="text-xs text-gray-700 mt-3">We acknowledge all reports within 24 hours</p>
          </div>
