  ...
  return (
    <div className="min-h-screen bg-cyber-bg grid-bg">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] radial-glow-blue pointer-events-none" />
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyber-blue/10 border border-cyber-blue/20 text-cyber-blue text-sm font-medium mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-heading text-white mb-4">
              ...
              <span className="text-cyber-blue">₹999</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {features.map((f, i) => (
                  <div key={i} className="cyber-card rounded-xl p-4">
                    <f.icon className="w-6 h-6 text-cyber-blue mb-2" />
            ...
            >
              <div className="cyber-card rounded-2xl p-8 relative overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-cyber-blue/50 to-transparent" />

                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-cyber-blue/10 border border-cyber-blue/20 mb-3">
                    <Shield className="w-7 h-7 text-cyber-blue" />
                  </div>
                  <div className="text-3xl font-bold text-white">₹999</div>
                  <div className="text-sm text-gray-400 mt-1">One-time · Instant delivery</div>
                ...
                <form onSubmit={handlePayment} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-cyber-border text-white placeholder-gray-500 text-sm focus:border-cyber-blue focus:ring-1 focus:ring-cyber-blue outline-none transition-all"
                    />
                  </div>
                  <div>
                ...
                <p className="mt-4 text-center text-xs text-gray-500">
                  ...
                  <Link href="/terms-of-service" className="text-cyber-blue hover:underline">Terms</Link>
                  {' '}and{' '}
                  <Link href="/privacy-policy" className="text-cyber-blue hover:underline">Privacy Policy</Link>.
                </p>
              </div>

              <div className="mt-4 text-center">
                <Link href="/contact" className="text-sm text-gray-400 hover:text-cyber-blue transition-colors flex items-center justify-center gap-1">
