        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            <motion.div {...fadeUp} className="lg:col-span-2">
                  ...
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {info.link ? (
                        ...
                        <span className="text-sm text-gray-700">{info.value}</span>
                      )}
                    </div>
                  </motion.div>
                ))}
              ...
              <motion.div {...fadeUp} transition={{ delay: 0.3 }} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="lg:col-span-3">
              <div className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 hover:shadow-sm transition">
                <h3 className="text-xl font-bold text-gray-900 font-heading mb-6">Request a Security Assessment</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input type="text" name="name" required value={formData.name} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm" placeholder="John Doe" />
                      </div>
                      <div>
                        <label className="block text-sm text-gray-500 mb-1.5">Email Address *</label>
                        <input type="email" name="email" required value={formData.email} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm" placeholder="john@company.com" />
                      </div>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm" placeholder="+91-XXXXX-XXXXX" />
                      </div>
                      <div>
                        <label className="block text-sm text-gray-500 mb-1.5">Company Name</label>
                        <input type="text" name="company" value={formData.company} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm" placeholder="Your Company" />
                      </div>
                    </div>

                    <div>
                      <label className="block text-sm text-gray-500 mb-1.5">Service Required</label>
                      <select name="service" value={formData.service} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm appearance-none">
                    ...
                    <div>
                      ...
                      <textarea name="message" required rows={5} value={formData.message} onChange={handleChange} className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-red-600 focus:ring-1 focus:ring-red-600 outline-none transition-colors text-sm resize-none" placeholder="Tell us about your security requirements, website URL, and any specific concerns..." />
                    </div>
